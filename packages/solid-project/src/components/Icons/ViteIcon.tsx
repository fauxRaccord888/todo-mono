export default function ViteIcon(props?: { class: string }) {
  return (
    <svg class={props?.class} xmlns="http://www.w3.org/2000/svg" width="31.88" height="32" preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 257">
      <defs>
